      ...
      {latestMetrics && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{latestMetrics.cpu_percent.toFixed(1)}%</div>
              <Badge
                variant={
                  latestMetrics.cpu_percent > 80
                    ? "destructive"
                    : latestMetrics.cpu_percent > 60
                      ? "secondary"
                      : "default"
                }
              >
                {latestMetrics.cpu_percent > 80 ? "High" : latestMetrics.cpu_percent > 60 ? "Medium" : "Normal"}
              </Badge>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{latestMetrics.memory_percent.toFixed(1)}%</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{latestMetrics.disk_percent.toFixed(1)}%</div>
              <p className="text-xs text-muted-foreground">
